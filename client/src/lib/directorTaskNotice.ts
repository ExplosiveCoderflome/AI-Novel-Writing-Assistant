    ...
    action: notice.action && typeof notice.action === "object"
      ? {
        ...
        label: typeof notice.action.label === "string" && notice.action.label.trim()
          ...
          : i18next.i18next.t("gen.lib.directorTaskNotice.gen_62c615c2"),
...
export function isChapterTitleDiversitySummary(value: string | null | undefined): boolean {
  ...
  return normalized.includes(i18next.i18next.t("gen.lib.directorTaskNotice.gen_083944a1"))
    || normalized.includes(i18next.i18next.t("gen.lib.directorTaskNotice.gen_9377d021"))
    || normalized.includes(i18next.i18next.t("gen.lib.directorTaskNotice.gen_85fb944c"));
}
...
export function resolveChapterTitleWarning(task: StructuredOutlineTaskLike | null | undefined): {
  ...
  if (taskNotice && isChapterTitleDiversitySummary(taskNotice.summary)) {
    return {
      ...
      label: i18next.i18next.t("gen.lib.directorTaskNotice.gen_62c615c2"),
