    ...
    >
      <TabsList>
        <TabsTrigger value="sections" className="gap-1.5">
          ...
          <span>{i18next.t("gen.pages.bookAnalysis.components.BookAnalysisWorkbenchViewTabs.gen_98016d32")}</span>
        </TabsTrigger>
        <TabsTrigger value="characters" className="gap-1.5">
          <Users className="h-3.5 w-3.5" />
          <span>{i18next.t("gen.pages.bookAnalysis.components.BookAnalysisWorkbenchViewTabs.gen_90154762")}</span>
