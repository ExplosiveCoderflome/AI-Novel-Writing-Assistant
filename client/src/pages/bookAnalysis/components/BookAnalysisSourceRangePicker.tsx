...
const CHAR_PRESETS = [
  { label: i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_9981494e"), value: 50_000 },
  { label: i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_ac3f6db5"), value: 100_000 },
  { label: i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_ca76f377"), value: 200_000 },
];
...
function parseCharInput(input: string): number | null {
  ...
  const unit = match[2];
  if (unit === i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_9d032066")) {
...
export default function BookAnalysisSourceRangePicker({
  ...
  const rangeTitle = selectedRange && selectedStartChapter && selectedEndChapter
    ...
    : i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_42d39e02");
  ...
  const charModeHint = selectedRange && selectedStartChapter && selectedEndChapter
    ...
    : i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_035c0223");

  return (
    <div className="space-y-2 rounded-md border bg-background p-3">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="text-sm font-medium">{i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_d7957d21")}</div>
        <div className="inline-flex rounded-md bg-muted/40 p-1">
          {([
            ["full", i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_42d39e02")],
            ["chapter", i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_c4bf99f5")],
            ["chars", i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_0270c742")],
        ...
        <div className="space-y-2">
          <div className="grid gap-2 lg:grid-cols-[1fr_1fr]">
            <Input
              ...
              placeholder={i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_0fba1a30")}
            />
            <Input
              className="h-9 text-xs"
              value={charEndInput}
              ...
              onBlur={() => applyCharRange(charStartInput, charEndInput)}
              placeholder={i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_bddbfb09")}
            />
          </div>
...
function RangeLoadHint({
  ...
  let message = i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_75736243");
  if (sourceSelected && loading) {
    message = i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_cde484ed");
  } else if (sourceSelected && error) {
    message = i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_9f824aba");
  } else if (sourceSelected && requested) {
    message = i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_585a6c1e");
  } else if (sourceSelected) {
    message = i18next.t("gen.pages.bookAnalysis.components.BookAnalysisSourceRangePicker.gen_636038db");
  }
  return (
