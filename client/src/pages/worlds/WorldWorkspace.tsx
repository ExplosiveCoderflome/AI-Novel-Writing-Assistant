    ...
    <div className="space-y-4">
      ...
      >
        <TabsList className="flex flex-wrap">
          ...
          <TabsTrigger value="sandbox">{i18next.t("gen.pages.worlds.WorldWorkspace.gen_79b70a06", "世界沙盒模拟")}</TabsTrigger>
        </TabsList>
            ...
            <>
              <Card>
                <CardHeader className="flex flex-row items-center justify-between gap-3">
                  ...
                  <Button variant="outline" size="sm" onClick={() => setAdvancedStructureOpen(false)}>{i18next.t("gen.pages.worlds.WorldWorkspace.gen_e3d6511f", "返回整理手册")}</Button>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground">{i18next.t("gen.pages.worlds.WorldWorkspace.gen_a0da9ee7", "这里用于处理势力关系、地点控制权、结构导入等细节。普通整理优先回到世界手册。")}</CardContent>
              </Card>
              {id ? (
                <WorldAxiomsCard
