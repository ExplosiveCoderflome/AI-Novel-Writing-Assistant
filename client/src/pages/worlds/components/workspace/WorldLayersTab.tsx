...
export default function WorldLayersTab(props: WorldLayersTabProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_3fa44531")}</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="flex flex-wrap items-center gap-2 rounded-md border p-3">
          <Button onClick={onGenerateAll} disabled={generateAllPending || !world}>
            {generateAllPending ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_d92453f0") : isInitialLayerGeneration ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.aiOrganizeSixLevelSummary") : i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_def9350c")}
          </Button>
          <div className="text-xs text-muted-foreground">
            {isInitialLayerGeneration
              ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_a89fc05a")
              : i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_34d7319e")}
          </div>
        </div>

        <div className="grid gap-3 lg:grid-cols-[240px_minmax(0,1fr)]">
          <div className="space-y-2 rounded-md border p-3">
            <div className="text-sm font-medium">{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_12473ca6")}</div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      ...
                      {hasDraft ? <span className="text-xs text-primary">{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_22b4334f")}</span> : null}
                    </div>
          ...
          <div className="rounded-md border p-3 space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              {hasSelectedDraft ? <div className="text-xs text-primary">{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_5b8d2077")}</div> : null}
            </div>
            <textarea
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                {isInitialLayerGeneration
                  ? generateAllPending
                    ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_764b448d")
                    : i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_11ba5ba1")
                  : isGeneratingSelectedLayer
                    ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_92f67f46")
                    : i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.aiOrganizeCurrentLevel")}
              </Button>
              <Button
                variant="secondary"
              ...
              >
                {isSavingSelectedLayer ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.savingInProgressDotDotDot") : i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.saveThisLayer")}
              </Button>
              <Button
                variant="outline"
              ...
              >
                {isConfirmingSelectedLayer ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_1fb26ee2") : i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_5ff268b9")}
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-md border p-3">
          <div className="mb-2 text-sm font-medium">{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.aiPolishing")}</div>
          <div className="grid gap-2 md:grid-cols-4">
            ...
            >
              <option value="replace">{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_f2bfdcd8")}</option>
              <option value="alternatives">{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_c87058b2")}</option>
            </SelectControl>
            <SelectControl
              className="rounded-md border bg-background p-2 text-sm"
              value={refineLevel}
            ...
            >
              <option value="light">{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_271fda47")}</option>
              <option value="deep">{i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_237fb19a")}</option>
            </SelectControl>
            <Button onClick={onStartRefine} disabled={refineStreaming}>
              {refineStreaming ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_d4ffc81b") : selectedLayer === "foundation" ? i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_a65da34b") : i18next.t("gen.pages.worlds.components.workspace.WorldLayersTab.gen_8d3d0618")}
            </Button>
          </div>
