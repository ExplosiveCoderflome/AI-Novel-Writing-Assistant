...
export default function NovelEdit() {
  ...
  useEffect(() => {
    ...
    const labels: Record<string, string> = {
      ...
      outline: "卷战略 / 卷骨架已打开",
      structured: "节奏 / 拆章已打开",
      chapter: selectedChapter ? i18next.t("novels.novelEdit.vc6f1r", { val1: (selectedChapter.order) }) : "章节执行已打开",
