...
export default function MobileNovelStepNav({
  ...
  return (
    <nav className="mobile-novel-step-nav -mx-4 flex gap-2 overflow-x-auto px-4 pb-1" aria-label={i18next.t("gen.pages.novels.mobile.MobileNovelStepNav.gen_2ddce323")}>
