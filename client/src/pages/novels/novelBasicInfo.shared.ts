...
export const WRITING_PLATFORM_OPTIONS: BasicInfoOption<NovelBasicFormState["writingPlatformPreference"]>[] = [
  { value: "ai_recommend", label: i18next.t("novels.novelBasicInfo.shared.11jkio"), summary: i18next.t("novels.novelBasicInfo.shared.kkj3r5"), recommended: true },
  { value: "fanqie_free", label: i18next.t("novels.novelBasicInfo.shared.jmzgas"), summary: i18next.t("novels.novelBasicInfo.shared.n8sn2t") },
  { value: "qidian_male", label: i18next.t("novels.novelBasicInfo.shared.ibfboc"), summary: i18next.t("novels.novelBasicInfo.shared.hc0tmv") },
  { value: "jinjiang_female", label: i18next.t("novels.novelBasicInfo.shared.dcsj5e"), summary: i18next.t("novels.novelBasicInfo.shared.2gigny") },
];
