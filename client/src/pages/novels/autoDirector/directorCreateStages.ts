...
export const AUTO_DIRECTOR_CREATE_STAGES: Array<{
  ...
  { key: "idea", order: 0, label: i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_ed3a57cd") },
  { key: "basic", order: 1, label: i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_06773c1e") },
  { key: "world_style", order: 2, label: i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_0dffbb3f") },
  { key: "model_run", order: 3, label: i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_061c5fc7") },
  { key: "candidates", order: 4, label: i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_875c5ec8") },
];
...
export function summarizeIdea(idea: string): string {
  ...
  if (!normalized) {
    return i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_ed870737");
  }
...
export function summarizeWorldStyleStage(input: {
  ...
  const worldLabel = selectedWorld
    ...
    : input.worldSetupMode === "skip"
      ? i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_5dcc48bb")
      : i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_3684d509");
  ...
  const styleLabel = styleProfile?.name
    ...
    ?? (input.basicForm.styleTone.trim() ? `文风：${input.basicForm.styleTone.trim()}` : i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_c9449912"));
...
export function summarizeModelRunStage(input: {
  ...
  return `${runModeLabel} · ${input.postGenerationStyleReviewEnabled ? i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_a28d5db1") : i18next.i18next.t("gen.pages.novels.autoDirector.directorCreateStages.gen_ae77d6e9")}`;
}
