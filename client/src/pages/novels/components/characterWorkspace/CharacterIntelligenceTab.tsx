...
export default function CharacterIntelligenceTab(props: CharacterIntelligenceTabProps) {
  ...
  if (mindQuery.isLoading) return <section className="rounded-3xl border border-dashed p-6 text-sm text-muted-foreground">{i18next.t("gen.pages.novels.components.characterWorkspace.CharacterIntelligenceTab.gen_d0eaa49e", "正在整理角色的谈话场景...")}</section>;
