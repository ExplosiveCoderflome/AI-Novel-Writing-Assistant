...
export function ContinuationSourceSection(props: ContinuationSourceSectionProps) {
  ...
  return (
    <SectionBlock
      title={i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_30a3cbb1")}
      description={i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_03c72dde")}
      surface="none"
    >
      <div className="space-y-2">
        <FieldLabel hint={BASIC_INFO_FIELD_HINTS.continuationSourceType}>{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_72eddec1")}</FieldLabel>
        <div className="grid gap-3 md:grid-cols-2">
          <SelectionCard
            option={{
              value: "novel",
              label: i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_ec8327f5"),
              summary: i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_058e1074"),
            }}
          ...
          <SelectionCard
            option={{
              ...
              label: i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_ecfe57c7"),
              summary: i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_3e0dbf84"),
            }}
      ...
      {basicForm.continuationSourceType === "novel" ? (
        <div className="space-y-2">
          <FieldLabel htmlFor="basic-source-novel">{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_f9418451")}</FieldLabel>
          <SelectControl
          ...
          >
            <option value="">{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_725b9d46")}</option>
        ...
        <div className="space-y-2">
          <FieldLabel htmlFor="basic-source-knowledge">{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_ecfe57c7")}</FieldLabel>
          <SelectControl
          ...
          >
            <option value="">{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_50fc44ac")}</option>
      ...
      {hasSelectedContinuationSource ? (
        <div className="space-y-3 pt-1">
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-sm font-medium text-foreground">{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_bd43b7d2", "拆书引用")}<HelpHint text={BASIC_INFO_FIELD_HINTS.continuationBookAnalysis} />
            </div>
          ...
          <div className="space-y-2">
            <FieldLabel htmlFor="basic-book-analysis">{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_64d477d1")}</FieldLabel>
            <SelectControl
            ...
            >
              <option value="">{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.noReferenceBook")}</option>
          ...
          {!isLoadingSourceNovelBookAnalyses && sourceNovelBookAnalysisOptions.length === 0 ? (
            <div className="text-xs text-muted-foreground">{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_65f2794e", "当前续写来源暂无可用拆书结果，需要先完成成功的拆书分析。")}</div>
          ) : null}

          {basicForm.continuationBookAnalysisId ? (
            <div className="space-y-2">
              <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                <span>{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_0175207d")}</span>
                <Button
                  size="sm"
                  variant="outline"
                  type="button"
                ...
                >{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_66eeacd9", "全选")}</Button>
                <Button
                  size="sm"
                  variant="outline"
                  type="button"
                  onClick={() => onFormChange({ continuationBookAnalysisSections: [] })}
                >{i18next.t("gen.pages.novels.components.basicInfoForm.ContinuationSourceSection.gen_288f0c40", "清空")}</Button>
              </div>
