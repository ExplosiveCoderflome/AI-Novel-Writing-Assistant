  ...
  return (
    ...
    >
      <summary className="cursor-pointer list-none">
        <CollapsibleSummary
          title={i18next.t("gen.pages.novels.components.CharacterDiagnosticsSection.gen_fc84cea5", "角色阵容与关系诊断")}
          description={i18next.t("gen.pages.novels.components.CharacterDiagnosticsSection.gen_1720cbdf", "需要补位、查缺口或整理阵容方案时再展开；角色动态、候选和卷级职责集中在“动态”页。")}
        />
      </summary>
