...
const IMAGE_STATUS_TEXT: Record<string, string> = {
  queued: i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_e5ac1d20"),
  running: i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_1ae3a984"),
  succeeded: i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_b6c4a445"),
  failed: i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_7f7de8a2"),
  cancelled: i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_2111ccbb"),
};
...
export function NovelCoverDialog(props: NovelCoverDialogProps) {
  ...
  const currentSendModeLabel = promptMode === "direct"
    ? (directPromptSource === "optimized" ? i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.optimizePromptA") : i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_3ec5bafe"))
    : i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_e799da59");
  ...
  const generateMutation = useMutation({
    mutationFn: async () => {
      if (!imageForm.provider) {
        throw new Error(i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_2a917a84"));
      }
  ...
  const handleDeleteAsset = async (asset: ImageAsset) => {
    const confirmed = window.confirm(i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_33b29bc7"));
    if (!confirmed) {
      return;
    }
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-6 py-5">
          {imageProviderOptions.length === 0 ? (
            <section className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
              <div className="font-medium">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_d77b36cd")}</div>
          ...
          <section className="space-y-2 rounded-2xl border border-slate-200 bg-slate-50/65 p-4">
            ...
            <textarea
              ...
              placeholder={i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_4c0325f8")}
              value={sourcePrompt}
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div className="space-y-2">
                <div className="text-xs font-medium uppercase tracking-[0.14em] text-slate-400">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.optimizeOutputLanguage")}</div>
              ...
              <div className="flex min-w-0 flex-col gap-3 xl:items-end">
                <div className="flex flex-wrap items-center gap-2 xl:flex-nowrap">
                  ...
                  >
                    {optimizeMutation.isPending ? i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.optimizingInProgress") : i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.optimizePromptB")}
                  </Button>
                  <Button
                    type="button"
                    variant="ghost"
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm xl:justify-end">
                  <span className="text-slate-500">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_ff04aacc")}</span>
          ...
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            <input
              ...
              placeholder={i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_fff197d5")}
              value={imageForm.stylePreset}
              onChange={(event) => updateStylePreset(event.target.value)}
            />
            <input
              className="rounded-xl border border-slate-200 bg-white p-3 text-sm shadow-sm outline-none transition focus:border-slate-400 focus:ring-2 focus:ring-slate-200 xl:col-span-2"
              placeholder={i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_2e91c7fa")}
              value={imageForm.negativePrompt}
              onChange={(event) => setImageForm((prev) => ({ ...prev, negativePrompt: event.target.value }))}
            />

            <label className="space-y-1 text-sm">
              <div className="text-xs font-medium uppercase tracking-[0.14em] text-slate-400">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_b51bd70b")}</div>
              <SelectControl
              ...
              >
                {imageProviderOptions.length === 0 ? (
                  <option value="">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_fca97c09")}</option>
                ) : null}
            ...
            <label className="space-y-1 text-sm">
              <div className="text-xs font-medium uppercase tracking-[0.14em] text-slate-400">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_c8339fd2")}</div>
              <SelectControl
                className="h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm shadow-sm outline-none transition focus:border-slate-400 focus:ring-2 focus:ring-slate-200"
              ...
              >
                <option value="1024x1536">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.sizeRecommendationVertical")}</option>
            ...
            <label className="space-y-1 text-sm">
              <div className="text-xs font-medium uppercase tracking-[0.14em] text-slate-400">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_3922a4bb")}</div>
              <SelectControl
                className="h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm shadow-sm outline-none transition focus:border-slate-400 focus:ring-2 focus:ring-slate-200"
              ...
              >
                <option value="1">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.onePage")}</option>
                <option value="2">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.twoPages")}</option>
                <option value="3">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.threePages")}</option>
                <option value="4">{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.fourPages")}</option>
              </SelectControl>
            </label>
            ...
            <div className="flex items-end">
              ...
              >
                {generateMutation.isPending ? i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_c661e656") : i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_dac38a8b")}
              </Button>
            </div>
          </div>
          ...
          {optimizeMutation.isError ? (
            <div className="rounded-2xl border border-destructive/20 bg-destructive/5 px-4 py-3 text-sm text-destructive">
              {getErrorMessage(optimizeMutation.error, i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.aiOptimizeFailedRetryLater"))}
            </div>
          ) : null}

          {generateMutation.isError ? (
            <div className="rounded-2xl border border-destructive/20 bg-destructive/5 px-4 py-3 text-sm text-destructive">
              {getErrorMessage(generateMutation.error, i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_d4023050"))}
            </div>
          ) : null}

          {activeTask ? (
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm">
              <div>{i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_f33bd525")}</div>
              {activeTask.error ? (
                ...
                {assets.map((asset) => (
                  <div key={asset.id} className="space-y-3 rounded-2xl border border-slate-200 bg-slate-50/60 p-3">
                    <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
                      <div className="aspect-[2/3] w-full">
                        <img
                          ...
                          alt={`${promptContext.title || i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_1fb52965")}封面候选图`}
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      >
                        {asset.isPrimary ? i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_c92a64ca") : i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_dbec491f")}
                      </span>
                      <span className="text-xs text-slate-500">
                        {asset.width && asset.height ? `${asset.width} x ${asset.height}` : i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_38716ccc")}
                      </span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      >
                        {asset.isPrimary ? i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_c92a64ca") : i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_7cd4e7cd")}
                      </Button>
                      <Button
                        type="button"
                        size="sm"
                        ...
                        onClick={() => {
                          void handleDeleteAsset(asset).catch((error) => {
                            window.alert(getErrorMessage(error, i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_fd21b734")));
                          });
                        }}
                      >
                        {deleteAssetMutation.variables === asset.id ? i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_09f2fb82") : i18next.t("gen.pages.novels.components.cover.NovelCoverDialog.gen_2f4aaddd")}
                      </Button>
                    </div>
                  </div>
                ))}
