  ...
  return (
    <div className="space-y-5">
      <DirectorTakeoverEntryPanel
        title={i18next.t("gen.pages.novels.components.WorldSetupTab.gen_1da83d27", "让 AI 完成本书世界观")}
        description={i18next.t("gen.pages.novels.components.WorldSetupTab.gen_47cffac0", "先确定世界规则、势力和关键约束，再让角色、卷规划与章节生产围绕同一份世界观继续推进。")}
        entry={props.directorTakeoverEntry}
      />
      <SectionBlock
        title={i18next.t("gen.pages.novels.components.WorldSetupTab.gen_c9b4a383", "世界观准备")}
        description={i18next.t("gen.pages.novels.components.WorldSetupTab.gen_b9d8c3d3", "这里维护本书实际使用的世界观。生成、检查和确认世界观时，AI 会以这些资产为依据。")}
      >
