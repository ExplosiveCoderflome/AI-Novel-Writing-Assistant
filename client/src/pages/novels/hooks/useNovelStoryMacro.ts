...
export function useNovelStoryMacro(input: UseNovelStoryMacroInput): {
  ...
  const decomposeMutation = useMutation({
    ...
    onSuccess: async (response) => {
      setMessage(response.message ?? i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_4c2811a6"));
      ...
      await syncNovelWorkflowStageSilently({
        novelId,
        stage: "story_macro",
        itemLabel: i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_f1d786e7"),
  ...
  const buildMutation = useMutation({
    ...
    onSuccess: async (response) => {
      setMessage(response.message ?? i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_3c40c8df"));
      await syncNovelWorkflowStageSilently({
        novelId,
        stage: "story_macro",
        itemLabel: i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_1327f080"),
        checkpointType: "book_contract_ready",
        checkpointSummary: i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_2b269744"),
        status: "waiting_approval",
      });
      await invalidatePlan();
    },
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: async (response) => {
      setMessage(response.message ?? i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_28e4552c"));
      await syncNovelWorkflowStageSilently({
        novelId,
        stage: "story_macro",
        itemLabel: i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_08b02ffd"),
        status: "waiting_approval",
      });
      await invalidatePlan();
    },
  ...
  const saveStateMutation = useMutation({
    ...
    onSuccess: async () => {
      setMessage(i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_71e9921f"));
      await invalidatePlan();
    },
  });
  ...
  const regenerateMutation = useMutation({
    ...
    onSuccess: async (response) => {
      setMessage(response.message ?? i18next.i18next.t("gen.pages.novels.hooks.useNovelStoryMacro.gen_2404ea38"));
      await invalidatePlan();
    },
    onSettled: () => {
