          ...
          <div className="mt-6">
            <TabsContent value="novel" className="mt-0 space-y-3">
              <div className="grid gap-3 md:grid-cols-[132px_minmax(0,1fr)] md:items-center">
                <label htmlFor="title-factory-novel" className="text-sm font-medium text-foreground">{i18next.t("gen.pages.titles.components.TitleFactoryPanel.gen_a55779fe", "选择小说项目")}</label>
                <SelectControl
              ...
              <div className="pl-0 text-xs leading-5 text-muted-foreground md:pl-[132px]">{i18next.t("gen.pages.titles.components.TitleFactoryPanel.gen_acb6f93b", "适合已填写简介和类型的作品，系统会结合项目资料生成候选标题。")}</div>
            </TabsContent>

            <TabsContent value="brief" className="mt-0 grid gap-4 md:grid-cols-[minmax(0,1fr)_240px]">
              <div className="space-y-3">
                <label htmlFor="title-factory-brief" className="text-sm font-medium text-foreground">{i18next.t("gen.pages.titles.components.TitleFactoryPanel.gen_c4d4530e", "创作简报")}</label>
                <textarea
              ...
              <div className="space-y-3">
                <label htmlFor="title-factory-genre" className="text-sm font-medium text-foreground">{i18next.t("gen.pages.titles.components.TitleFactoryPanel.gen_6ad27cd6", "类型过滤")}</label>
                <SelectControl
                ...
                <p className="text-xs leading-5 text-muted-foreground">{i18next.t("gen.pages.titles.components.TitleFactoryPanel.gen_2ed143f7", "不确定类型时可以留空，让模型先按简报自行判断标题方向。")}</p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="adapt" className="mt-0 space-y-4">
              <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_240px]">
                <div className="space-y-3">
                  <label htmlFor="title-factory-reference" className="text-sm font-medium text-foreground">{i18next.t("gen.pages.titles.components.TitleFactoryPanel.gen_3757d569", "参考标题")}</label>
                  <Input
                ...
                <div className="space-y-3">
                  <label htmlFor="title-factory-adapt-genre" className="text-sm font-medium text-foreground">{i18next.t("gen.pages.titles.components.TitleFactoryPanel.gen_6ad27cd6", "类型过滤")}</label>
                  <SelectControl
              ...
              <div className="space-y-3">
                <label htmlFor="title-factory-adapt-brief" className="text-sm font-medium text-foreground">{i18next.t("gen.pages.titles.components.TitleFactoryPanel.gen_9da6007d", "作品简报")}</label>
                <textarea
