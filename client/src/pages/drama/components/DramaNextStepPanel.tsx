...
function buildNextStep(project: DramaProjectDetail): NextStep {
  ...
  if (!project.sourceBundle) {
    return {
      kind: "source",
      title: i18next.t("gen.pages.drama.components.DramaNextStepPanel.nextStepOrganizeMaterials"),
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_b9b07305"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_eeb01df4"),
      tab: "source",
      icon: "source",
    };
  }
  if (!project.strategy) {
    return {
      kind: "strategy",
      title: i18next.t("gen.pages.drama.components.DramaNextStepPanel.nextStepGenerateDramaStrategy"),
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_cc9d0449"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_5f66b6de"),
      tab: "strategy",
      icon: "strategy",
    };
  }
  if (episodes.length === 0) {
    return {
      kind: "outline",
      title: i18next.t("gen.pages.drama.components.DramaNextStepPanel.nextStepGenerateFirst12Episodes"),
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_1a8b5635"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_ecc3b873"),
      tab: "episodes",
      icon: "outline",
    };
  }
  if (unscripted) {
    return {
      ...
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_0cb9ca78"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_7f83dc3d"),
      tab: "episodes",
      icon: "script",
  ...
  if (repairable) {
    return {
      ...
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_4e692cb2"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_98a2f9a0"),
      tab: "episodes",
      icon: "repair",
  ...
  if (unreviewed) {
    return {
      ...
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_9c5ff664"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_6fc8894d"),
      tab: "episodes",
      icon: "review",
  ...
  if (unstagedStoryboard) {
    return {
      ...
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_65853d35"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_3d45375e"),
      tab: "visual",
      icon: "video",
  ...
  if (shotWithoutPrompt) {
    return {
      ...
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_b644c21e"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_9bcc2e2b"),
      tab: "visual",
      icon: "video",
  ...
  if (promptWithoutTask) {
    return {
      kind: "providerTask",
      title: i18next.t("gen.pages.drama.components.DramaNextStepPanel.nextTaskCreateVideo"),
      description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_c66a6fc9"),
      button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_b053cdd5"),
      tab: "visual",
      icon: "video",
  ...
  return {
    kind: "export",
    title: i18next.t("gen.pages.drama.components.DramaNextStepPanel.nextStepExportInfo"),
    description: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_8d8e1958"),
    button: i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_f33dea55"),
    tab: "export",
    icon: "export",
  };
}
      ...
      <CardHeader className="gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge variant="outline">{i18next.t("gen.pages.drama.components.DramaNextStepPanel.projectTargetEpisodes")}</Badge>
          </div>
          <CardDescription>{step.description}</CardDescription>
        </div>
        <Button type="button" disabled={props.busy} onClick={runStep}>
          <StepIcon icon={step.icon} />
          {props.busy ? i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_2fb90b05") : step.button}
        </Button>
      </CardHeader>
      <CardContent className="flex flex-wrap gap-2 text-sm text-muted-foreground">
        <span>{i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_ef161d55")}</span>
        <span>{i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_9a7ad427")}</span>
        <span>{i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_4ed0720f")}</span>
        <span>{i18next.t("gen.pages.drama.components.DramaNextStepPanel.gen_68c68a2c")}</span>
      </CardContent>
    </Card>
  );
}
