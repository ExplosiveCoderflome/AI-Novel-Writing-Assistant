    ...
    <div className="space-y-3">
      ...
      <div className="rounded-md border border-border bg-muted/20 p-3">
        ...
        <div
          ...
          role="progressbar"
          aria-label={i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_9322bdef", "开书信息完成度")}
          aria-valuemin={0}
          aria-valuemax={100}
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2 text-[11px]">
                {item.requiredForProduction ? (
                  <span className="rounded-md border border-current/20 bg-background/70 px-2 py-0.5">{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_4fc1fd0a", "生产前确认")}</span>
                ) : null}
                <span>
            ...
            {item.status !== "ready" && (item.recommendedAction || item.optionPrompt) ? (
              <div className="mt-3 flex flex-wrap gap-2">
                {item.recommendedAction ? (
                  ...
                  >{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_b737649d", "补这项")}</Button>
                ) : null}
                {item.optionPrompt ? (
                  <Button
                    type="button"
                  ...
                  >{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_c3666112", "给我备选")}</Button>
                ) : null}
              </div>
            ) : null}
          </div>
      ...
      {pendingItems.length > 0 ? (
        <div className="rounded-md border border-warning/30 bg-warning/5 p-3">
          <div className="text-xs font-medium text-warning">{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_636c8913", "生产前待确认")}</div>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            >{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_beffa430", "生成确认清单")}</Button>
            <Button
              type="button"
              size="sm"
              variant="outline"
            ...
            >{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_7e084800", "批量给我备选")}</Button>
          </div>
        </div>
      ) : null}

      <div className="rounded-md border border-info/30 bg-info/5 p-3">
        <div className="text-xs font-medium text-info">{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_acf4d5ca", "下一项信息")}</div>
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        >{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_b97af93a", "按引导继续")}</Button>
        <Button
          type="button"
          size="sm"
          variant="outline"
        ...
        >{i18next.t("gen.pages.creativeHub.components.CreativeHubNovelSetupCard.gen_7126c56a", "查看初始化摘要")}</Button>
      </div>
    </div>
  );
}
