...
export function formatHomeDate(value: string | undefined): string {
  if (!value) {
    return i18next.i18next.t("gen.pages.home.homeViewModel.gen_f61f4cf6");
  }
...
export function getNovelLeadSummary(novel: HomeNovelItem): string {
  ...
  return i18next.i18next.t("gen.pages.home.homeViewModel.gen_93364b21");
}
...
export function buildHomeNextAction(primaryNovel: HomeNovelItem | null): HomeNextAction {
  if (!primaryNovel) {
    return {
      kind: "starter",
      eyebrow: i18next.i18next.t("gen.pages.home.homeViewModel.gen_de6465aa"),
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_9c3aa028"),
      description: i18next.i18next.t("gen.pages.home.homeViewModel.gen_059a2612"),
      reason: i18next.i18next.t("gen.pages.home.homeViewModel.gen_eace0878"),
      tone: "info",
    };
  }
  ...
  if (canContinueChapterBatchAutoExecution(task)) {
    return {
      kind: "novel",
      eyebrow: i18next.i18next.t("gen.pages.home.homeViewModel.gen_9ff48c30"),
      title: `恢复《${primaryNovel.title}》的章节执行`,
      description: getNovelLeadSummary(primaryNovel),
      reason: i18next.i18next.t("gen.pages.home.homeViewModel.gen_036b9ab0"),
      tone: "danger",
    };
  }
  if (requiresCandidateSelection(task)) {
    return {
      ...
      description: getNovelLeadSummary(primaryNovel),
      reason: i18next.i18next.t("gen.pages.home.homeViewModel.gen_c2813e84"),
      tone: "warning",
    };
  }
  if (canContinueDirector(task)) {
    return {
      ...
      description: getNovelLeadSummary(primaryNovel),
      reason: i18next.i18next.t("gen.pages.home.homeViewModel.gen_7aa3fedb"),
      tone: "warning",
    };
  }
  if (task?.status === "running" || task?.status === "queued") {
    return {
      kind: "novel",
      eyebrow: i18next.i18next.t("gen.pages.home.homeViewModel.gen_daf87615"),
      title: `关注《${primaryNovel.title}》的后台进度`,
      description: getNovelLeadSummary(primaryNovel),
      reason: i18next.i18next.t("gen.pages.home.homeViewModel.gen_e3f5c26f"),
      tone: "info",
    };
  }
  if (canEnterChapterExecution(task)) {
    return {
      ...
      description: getNovelLeadSummary(primaryNovel),
      reason: i18next.i18next.t("gen.pages.home.homeViewModel.gen_c69fb4b4"),
      tone: "success",
    };
  }
  if (task?.status === "failed" || task?.status === "cancelled") {
    return {
      kind: "novel",
      eyebrow: i18next.i18next.t("gen.pages.home.homeViewModel.gen_54dc8247"),
      title: `查看《${primaryNovel.title}》的推进状态`,
      description: getNovelLeadSummary(primaryNovel),
      reason: i18next.i18next.t("gen.pages.home.homeViewModel.gen_9c5e9796"),
      tone: "danger",
    };
  }
  return {
    ...
    description: getNovelLeadSummary(primaryNovel),
    reason: i18next.i18next.t("gen.pages.home.homeViewModel.gen_083bfa9b"),
    tone: "neutral",
  };
}
...
export function buildHomeMetrics(input: {
  ...
  return [
    {
      id: "running",
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_007edf50"),
      value: liveWorkflowCount,
      hint: i18next.i18next.t("gen.pages.home.homeViewModel.gen_bba3e2f7"),
      tone: "info",
    },
    {
      id: "attention",
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_047109de"),
      value: actionRequiredCount,
      hint: i18next.i18next.t("gen.pages.home.homeViewModel.gen_95c7ebda"),
      tone: actionRequiredCount > 0 ? "warning" : "success",
    },
    {
      id: "chapter-ready",
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_7d7acbea"),
      value: readyForExecutionCount,
      hint: i18next.i18next.t("gen.pages.home.homeViewModel.gen_c7ea8ff7"),
      tone: readyForExecutionCount > 0 ? "success" : "neutral",
    },
    {
      id: "failed",
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_a8a1f41f"),
      value: failedTaskCount,
      hint: i18next.i18next.t("gen.pages.home.homeViewModel.gen_ef51266d"),
...
export function buildHomeAttentionItems(input: {
  ...
  if (failedTaskCount > 0 || recoveryCandidateCount > 0) {
    items.push({
      ...
      description: i18next.i18next.t("gen.pages.home.homeViewModel.gen_6b7dbd6f"),
      tone: failedTaskCount > 0 ? "danger" : "warning",
      to: "/tasks",
      actionLabel: i18next.i18next.t("gen.pages.home.homeViewModel.gen_9dd8c364"),
    });
  }
  if (actionRequiredCount > 0 || waitingApprovalCount > 0) {
    items.push({
      ...
      description: i18next.i18next.t("gen.pages.home.homeViewModel.gen_3f382d26"),
      tone: "warning",
      to: "/auto-director/follow-ups",
      actionLabel: i18next.i18next.t("gen.pages.home.homeViewModel.gen_cb22c7c1"),
    });
  }
  if (readyForExecutionCount > 0) {
    items.push({
      ...
      description: i18next.i18next.t("gen.pages.home.homeViewModel.gen_4b9e5601"),
      tone: "success",
    });
  }
  if (runningCount > 0) {
    items.push({
      ...
      description: i18next.i18next.t("gen.pages.home.homeViewModel.gen_758ac9f9"),
      tone: "info",
      to: "/tasks",
      actionLabel: i18next.i18next.t("gen.pages.home.homeViewModel.gen_9600c918"),
    });
  }
...
export function buildHomeAssetHealthItems(novels: HomeNovelItem[]): HomeAssetHealthItem[] {
  ...
  return [
    {
      id: "world",
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_ccd81d16"),
      value: totalNovels > 0 ? `${worldBoundCount}/${totalNovels}` : "0",
      description: totalNovels > 0
        ? i18next.i18next.t("gen.pages.home.homeViewModel.gen_1d29dac7")
        : i18next.i18next.t("gen.pages.home.homeViewModel.gen_42f59f8a"),
      tone: totalNovels === 0 ? "neutral" : worldBoundCount === totalNovels ? "success" : "warning",
    },
    {
      id: "characters",
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_88afed0d"),
      value: String(totalCharacters),
      description: i18next.i18next.t("gen.pages.home.homeViewModel.gen_33399576"),
      tone: totalCharacters > 0 ? "success" : "warning",
    },
    {
      id: "chapters",
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_6ee26458"),
      value: String(totalChapters),
      description: i18next.i18next.t("gen.pages.home.homeViewModel.gen_7d8e24a2"),
      tone: totalChapters > 0 ? "info" : "neutral",
    },
    {
      id: "readiness",
      title: i18next.i18next.t("gen.pages.home.homeViewModel.gen_31032ccf"),
      value: averageResourceScore == null ? "--" : `${averageResourceScore}`,
      description: i18next.i18next.t("gen.pages.home.homeViewModel.gen_ccc59df1"),
