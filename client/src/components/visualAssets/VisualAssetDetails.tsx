        ...
        {asset ? (
          <>
            ...
            <div className="space-y-3 text-sm">
              ...
              <DetailRow label="Affiliation details" value={asset.scope.label || getVisualAssetScopeLabel(asset.scope.kind)} />
              <DetailRow label="Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know." value={formatVisualAssetDate(asset.createdAt)} />
              {asset.width && asset.height ? <DetailRow label="Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know." value={`${asset.width} × ${asset.height}`} /> : null}
