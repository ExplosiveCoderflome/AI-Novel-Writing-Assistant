...
function displayStateLabel(state: DirectorBookAutomationDisplayState): string {
  const labels: Record<DirectorBookAutomationDisplayState, string> = {
    processing: i18next.t("gen.components.autoDirector.AICockpit.aiProcessing"),
    needs_confirmation: i18next.t("gen.components.autoDirector.AICockpit.gen_493b7bc5"),
    paused: i18next.t("gen.components.autoDirector.AICockpit.gen_a2d930fd"),
    needs_attention: i18next.t("gen.components.autoDirector.AICockpit.gen_2144b3d6"),
    completed: i18next.t("gen.components.autoDirector.AICockpit.gen_fad5222c"),
    idle: i18next.t("gen.components.autoDirector.AICockpit.gen_ea4a363d"),
  };
  return labels[state];
}
...
function formatDate(value: string | null | undefined): string {
  if (!value) {
    return i18next.t("gen.components.autoDirector.AICockpit.gen_f61f4cf6");
  }
...
function formatDuration(value: number | null | undefined): string | null {
  ...
  if (seconds <= 0) {
    return i18next.t("gen.components.autoDirector.AICockpit.lessThanOneSecond");
  }
  if (seconds < 60) {
    return `${seconds} 秒`;
  }
...
function fallbackProjectionReason(props: Pick<AICockpitProps, "fallbackSummary">): string {
  return props.fallbackSummary?.trim() || i18next.t("gen.components.autoDirector.AICockpit.gen_1c5b29dc");
}
...
function renderActionLabel(
  ...
  if (
    ...
    return i18next.t("gen.components.autoDirector.AICockpit.gen_eca060fa");
  }
  return action.label || i18next.t("gen.components.autoDirector.AICockpit.gen_a53fb331");
}

function artifactTypeLabel(type: string): string {
  const labels: Record<string, string> = {
    book_contract: i18next.t("gen.components.autoDirector.AICockpit.chapterConvention"),
    story_macro: i18next.t("gen.components.autoDirector.AICockpit.gen_6a01070b"),
    character_cast: i18next.t("gen.components.autoDirector.AICockpit.gen_464f3d4e"),
    volume_strategy: i18next.t("gen.components.autoDirector.AICockpit.gen_725b781b"),
    chapter_task_sheet: i18next.t("gen.components.autoDirector.AICockpit.singleTask"),
    chapter_draft: i18next.t("gen.components.autoDirector.AICockpit.gen_58378f0d"),
    audit_report: i18next.t("gen.components.autoDirector.AICockpit.gen_4719af71"),
    repair_ticket: i18next.t("gen.components.autoDirector.AICockpit.gen_f82661e8"),
    reader_promise: i18next.t("gen.components.autoDirector.AICockpit.gen_4ac4f0e0"),
    character_governance_state: i18next.t("gen.components.autoDirector.AICockpit.gen_418464ba"),
    world_skeleton: i18next.t("gen.components.autoDirector.AICockpit.worldFramework"),
    source_knowledge_pack: i18next.t("gen.components.autoDirector.AICockpit.gen_2813d60b"),
    chapter_retention_contract: i18next.t("gen.components.autoDirector.AICockpit.gen_03f216fe"),
    continuity_state: i18next.t("gen.components.autoDirector.AICockpit.gen_511e066d"),
    rolling_window_review: i18next.t("gen.components.autoDirector.AICockpit.gen_683cfa71"),
  };
...
function recoveryActionLabel(
  ...
  const labels: Record<string, string> = {
    retry: i18next.t("gen.components.autoDirector.AICockpit.gen_67193fe1"),
    resume_after_review: i18next.t("gen.components.autoDirector.AICockpit.gen_72660028"),
    switch_model: i18next.t("gen.components.autoDirector.AICockpit.gen_cb021c7c"),
    confirm_protected_content: i18next.t("gen.components.autoDirector.AICockpit.gen_f59dcf0b"),
    manual_repair: i18next.t("gen.components.autoDirector.AICockpit.gen_895ffcc5"),
  };
...
function workerStateLabel(
  ...
  const labels: Record<NonNullable<DirectorBookAutomationProjection["workerHealth"]>["derivedState"], string> = {
    idle: i18next.t("gen.components.autoDirector.AICockpit.gen_4f8a2f0b"),
    queued_waiting_worker: i18next.t("gen.components.autoDirector.AICockpit.gen_bad4ca82"),
    leased_starting: i18next.t("gen.components.autoDirector.AICockpit.gen_a57c2866"),
    running_step: i18next.t("gen.components.autoDirector.AICockpit.gen_1dda67ba"),
    waiting_gate: i18next.t("gen.components.autoDirector.AICockpit.gen_70f361ce"),
    auto_recovering: i18next.t("gen.components.autoDirector.AICockpit.gen_bfa39d48"),
    cancelled: i18next.t("gen.components.autoDirector.AICockpit.gen_82977854"),
    failed_recoverable: i18next.t("gen.components.autoDirector.AICockpit.gen_b77db710"),
    failed_hard: i18next.t("gen.components.autoDirector.AICockpit.gen_54dc8247"),
    succeeded: i18next.t("gen.components.autoDirector.AICockpit.gen_fad5222c"),
  };
...
function workerStateDetail(health: NonNullable<DirectorBookAutomationProjection["workerHealth"]>): string {
  ...
  if (health.queuedCommandCount > 0) {
    return i18next.t("gen.components.autoDirector.AICockpit.taskQueuedBackgroundExecutionWillContinue");
  }
  if (health.runningCommandCount > 0 || health.leasedCommandCount > 0) {
    return i18next.t("gen.components.autoDirector.AICockpit.gen_4a0c2a9a");
  }
  if (health.staleCommandCount > 0) {
    return i18next.t("gen.components.autoDirector.AICockpit.gen_37e5615c");
  }
  return i18next.t("gen.components.autoDirector.AICockpit.gen_e08ee18a");
}
...
export default function AICockpit(props: AICockpitProps) {
      ...
      <div className="rounded-2xl bg-muted/25 p-4">
        <div className="flex items-start justify-between gap-2">
          <div className="flex min-w-0 items-start gap-2">
            ...
            <div className="min-w-0">
              <div className="text-sm font-semibold text-foreground">{i18next.t("gen.components.autoDirector.AICockpit.aiCockpit")}</div>
  ...
  const statusDetail = reason === statusHeadline
    ? focusProjection.progressSummary?.trim() || i18next.t("gen.components.autoDirector.AICockpit.gen_5bb3c43b")
    : reason;
  const latestRecordText = recentItems[0] ? formatDate(recentItems[0].occurredAt) : i18next.t("gen.components.autoDirector.AICockpit.gen_f61f4cf6");
    ...
    <div className="space-y-4">
      <section className={cn("rounded-2xl p-5 shadow-sm", stateSoftSurfaceClassName(focusProjection.displayState))}>
        ...
        <div className="mt-5 grid gap-3 rounded-xl bg-background/60 p-3 sm:grid-cols-3">
          <SummaryMetric
            label={i18next.t("gen.components.autoDirector.AICockpit.gen_6bf1f392")}
            value={displayStateLabel(focusProjection.displayState)}
            className={stateAccentClassName(focusProjection.displayState)}
          />
          <SummaryMetric label={i18next.t("gen.components.autoDirector.AICockpit.gen_99d93845")} value={focusProjection.progressSummary || i18next.t("gen.components.autoDirector.AICockpit.gen_8a5a9e09")} />
          <SummaryMetric label={i18next.t("gen.components.autoDirector.AICockpit.gen_b66b2e82")} value={latestRecordText} />
        </div>

        <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div className="min-w-0">
            <div className="text-[11px] text-muted-foreground">{i18next.t("gen.components.autoDirector.AICockpit.nextStep")}</div>
            <div className="mt-1 text-sm font-medium leading-5 text-foreground">
              {focusProjection.nextActionLabel || i18next.t("gen.components.autoDirector.AICockpit.gen_f13fdaab")}
            </div>
          </div>
          <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
            <Button type="button" size="sm" onClick={handlePrimaryAction} disabled={isActionPending}>
              {isActionPending ? i18next.t("gen.components.autoDirector.AICockpit.gen_2fb90b05") : renderActionLabel(primaryAction ?? {
                type: "open_novel",
                label: i18next.t("gen.components.autoDirector.AICockpit.gen_69e59351"),
      ...
      {circuitBreaker ? (
        <section className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3 text-sm leading-6 text-destructive">
          <div className="font-medium">{i18next.t("gen.components.autoDirector.AICockpit.gen_a2b070d1")}</div>
          <div className="mt-1">{circuitBreaker.message || i18next.t("gen.components.autoDirector.AICockpit.circuitError")}</div>
          {circuitRecovery ? <div className="mt-1">{i18next.t("gen.components.autoDirector.AICockpit.gen_a6fa6670")}</div> : null}
        </section>
      ) : null}
      ...
      {workerHealth ? (
        <section className="rounded-2xl bg-muted/25 px-4 py-3">
          ...
          <div className="mt-3 grid grid-cols-4 gap-3">
            <SummaryMetric label={i18next.t("gen.components.autoDirector.AICockpit.gen_0b5880b9")} value={workerHealth.queuedCommandCount} />
            <SummaryMetric label={i18next.t("gen.components.autoDirector.AICockpit.gen_88b4d042")} value={workerHealth.leasedCommandCount} />
            <SummaryMetric label={i18next.t("gen.components.autoDirector.AICockpit.gen_1a6aa24e")} value={workerHealth.runningCommandCount} />
            <SummaryMetric label={i18next.t("gen.components.autoDirector.AICockpit.gen_c7db6d4f")} value={workerHealth.staleCommandCount} />
          </div>
          {workerHealth.oldestQueuedWaitMs ? (
            <div className="mt-2 text-[11px] text-muted-foreground">
              等待接手 {formatDuration(workerHealth.oldestQueuedWaitMs) ?? i18next.t("gen.components.autoDirector.AICockpit.lessThanOneSecond")}
            </div>
          ) : null}
        </section>
      ) : null}
      ...
      {usageSummary ? (
        <DetailPanel
          title={i18next.t("gen.components.autoDirector.AICockpit.aiUsage")}
          ...
          <div className="space-y-3 text-xs leading-5 text-muted-foreground">
            ...
            {promptUsage.length > 0 ? (
              <div className="space-y-1">
                <div className="font-medium text-foreground">{i18next.t("gen.components.autoDirector.AICockpit.gen_e306281d")}</div>
            ...
            {stepUsage.length > 0 ? (
              <div className="space-y-1">
                <div className="font-medium text-foreground">{i18next.t("gen.components.autoDirector.AICockpit.gen_6f258816")}</div>
                <div className="divide-y divide-border/60">
                  {stepUsage.map((item) => (
      ...
      {recentItems.length > 0 ? (
        <DetailPanel
          title={i18next.t("gen.components.autoDirector.AICockpit.gen_d0fb8b91")}
            ...
            {recentItems.map((item) => (
              <div key={item.id} className="py-2">
                ...
                {item.usage ? (
                  ...
                  <div className="mt-1 text-muted-foreground">{i18next.t("gen.components.autoDirector.AICockpit.gen_898d03c7")}</div>
                ) : null}
