...
function riskLabel(riskLevel: DirectorAutoApprovalPoint["riskLevel"]): string {
  if (riskLevel === "high") return i18next.t("gen.components.autoDirector.AutoDirectorApprovalPointMultiSelect.gen_4433e710");
  if (riskLevel === "medium") return i18next.t("gen.components.autoDirector.AutoDirectorApprovalPointMultiSelect.midRisk");
  return i18next.t("gen.components.autoDirector.AutoDirectorApprovalPointMultiSelect.lowRisk");
}
...
export function summarizeDirectorAutoApprovalPoints(codes: string[]): string {
  ...
  if (normalized.length === 0) {
    return i18next.t("gen.components.autoDirector.AutoDirectorApprovalPointMultiSelect.notAutoApprove");
  }
