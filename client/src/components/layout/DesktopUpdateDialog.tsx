...
export default function DesktopUpdateDialog({ trigger }: DesktopUpdateDialogProps) {
  ...
  return (
    <Dialog>
      ...
      <AppDialogContent
        className="max-w-2xl"
        title={i18next.t("gen.components.layout.DesktopUpdateDialog.gen_3c1d148b", "版本与更新")}
        description={i18next.t("gen.components.layout.DesktopUpdateDialog.gen_777abf83", "查看桌面版状态，并在确认后下载和安装新版本。")}
      >
