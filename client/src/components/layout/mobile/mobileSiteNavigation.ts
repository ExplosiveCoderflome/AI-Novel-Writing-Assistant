...
export const MOBILE_ROUTE_PATTERNS: MobileRoutePattern[] = [
  ...
  { key: "genres", pattern: /^\/genres\/?$/, title: "题材基底库", group: "more" },
  { key: "story-modes", pattern: /^\/story-modes\/?$/, title: "推进模式库", group: "more" },
  ...
  { key: "base-characters", pattern: /^\/base-characters\/?$/, title: "基础角色库", group: "more" },
];
...
const primaryNavItems: MobileNavItem[] = [
  ...
  { key: "tasks", label: "记录", to: "/tasks", group: "tasks" },
...
const moreNavGroups: MobileNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "genres", label: "题材基底库", to: "/genres", group: "more" },
      { key: "story-modes", label: "推进模式库", to: "/story-modes", group: "more" },
      ...
      { key: "base-characters", label: "基础角色库", to: "/base-characters", group: "more" },
