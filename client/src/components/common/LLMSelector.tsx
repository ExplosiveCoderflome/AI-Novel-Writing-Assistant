  ...
  return (
    <div className={cn("space-y-2", compact && "space-y-1", className)}>
      <div className={cn("flex min-w-0 items-center gap-2", compact ? "flex-nowrap gap-1.5" : "flex-wrap")}>
        {showBadge ? <Badge variant="secondary">{i18next.t("gen.components.common.LLMSelector.gen_8000f187")}</Badge> : null}
        <Select
        ...
        >
          <SelectTrigger className={cn(compact ? "h-9 w-[148px] lg:w-[164px]" : "w-full sm:w-[180px]")}>
            <SelectValue placeholder={hasRunnableProviders ? i18next.t("gen.components.common.LLMSelector.gen_c6d3930b") : i18next.t("gen.components.common.LLMSelector.gen_0597dad8")} />
          </SelectTrigger>
          <SelectContent>
            {!hasRunnableProviders ? (
        ...
        {showModel ? (
          <SearchableSelect
            ...
            placeholder={hasRunnableProviders ? i18next.t("gen.components.common.LLMSelector.gen_f2d3731b") : i18next.t("gen.components.common.LLMSelector.gen_2d6b332e")}
            searchPlaceholder={i18next.t("gen.components.common.LLMSelector.gen_8288a2e8")}
            emptyText={i18next.t("gen.components.common.LLMSelector.gen_039e58de")}
      ...
      {showParameters ? (
        <div className="grid gap-2 md:grid-cols-2">
          <label className="space-y-1 text-sm">
            <span className="text-muted-foreground">{i18next.t("gen.components.common.LLMSelector.gen_ac92ced8")}</span>
            <Input
              type="number"
              step="0.1"
              min={0}
          ...
          <label className="space-y-1 text-sm">
            <span className="text-muted-foreground">{i18next.t("gen.components.common.LLMSelector.gen_19e57799")}</span>
            <Input
              type="number"
              step="1"
              min={256}
