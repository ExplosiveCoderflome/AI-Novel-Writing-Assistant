...
export default function SearchableSelect({
  ...
  onValueChange,
  options,
  placeholder = i18next.t("gen.components.common.SearchableSelect.gen_708c9d6d"),
  searchPlaceholder = i18next.t("gen.components.common.SearchableSelect.gen_e5f71fc3"),
  emptyText = i18next.t("gen.components.common.SearchableSelect.gen_da6453cd"),
  disabled = false,
  className,
  triggerClassName,
  contentClassName,
