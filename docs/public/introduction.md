...
宫涵小说自动化工作台是一套帮助你把灵感推进成长篇小说的创作工具。它不要求你一开始就会写大纲、设计人物关系、拆卷或控制节奏，而是把这些步骤拆成可执行的链路，让 AI 在每一步给出可选择、可保存、可继续的结果。
...
创作中枢是你和系统沟通创作意图的入口。你可以在这里描述目标、询问下一步、发起任务、查看建议，也可以让系统把模糊想法整理成更明确的创作任务。

如果你不知道某个功能入口在哪里，可以先从创作中枢或新手上路开始。系统会尽量把任务导向小说主链，而不是让对话停留在泛泛建议。
...
- 最新版本页：[GitHub Releases](https://github.com/Gonghan-Princess/AI-Novel-Writing-Assistant/releases/latest)
- 建议优先下载安装版。
- 不想安装时，可以选择 portable 版本直接运行。

源码和项目仓库：

[AI-Novel-Writing-Assistant](https://github.com/Gonghan-Princess/AI-Novel-Writing-Assistant)
