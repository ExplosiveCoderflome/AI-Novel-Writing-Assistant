...
**Biz Novel Studio**（简称 **Biz Studio**）是一套帮助你把灵感推进成长篇小说的 AI 小说创作工作台。它不要求你一开始就会写大纲、设计人物关系、拆卷或控制节奏，而是把这些步骤拆成可执行的链路，让 AI 在每一步给出可选择、可保存、可继续的结果。

项目原名为 **AI Novel Writing Assistant / AI 小说创作工作台**。名称更新不影响原 GitHub 仓库、下载入口和本地作品数据。
