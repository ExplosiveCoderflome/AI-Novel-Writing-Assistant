...
- 新增“热门题材雷达”，进入页面会先自动获取并展示番茄、起点和晋江的公开排行榜，可以逐榜查看排名、书名、作者和分类；扫榜阶段会独立完成到 100%，新书榜与晋江新晋作者榜会优先展示并成为开书分析的主要参考，番茄书名会从公开作品信息中校正为正常文字。确认榜单数据后再点击“开始AI分析”，由 AI 归纳近期高热题材、主角身份、金手指、开局爆点、关系卖点、标题模式、拥挤套路与差异化机会。
