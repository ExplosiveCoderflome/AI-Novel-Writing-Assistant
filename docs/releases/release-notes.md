...
- 自动导演的起始想法新增“故事星图”：可以从人物底色、世界压力、开局钩子、长线欲望、关键变量和关系张力中组合元素，再由 AI 整理成可直接开书的一段想法。
...
- 提示词工作台的目录状态标签、沉浸编辑按钮、编辑区、底部操作栏和试写弹窗会跟随当前主题；深色暖纸主题会使用中性深蓝工作画布，避免大块棕色底色、白字失去背景或难以辨认的文字。
