...
- 首批来源为番茄阅读榜 / 新书榜、起点畅销榜 / 月票榜 / 新书榜、晋江月度榜 / 季度榜 / 新晋作者榜；每个来源最多保留前 30 项公开元数据。
...
- 平台存在可用新书榜或晋江新晋作者榜时，AI平台归纳只接收这些新书证据；成熟榜单继续展示和保存，但不进入本次分析。只有新书榜缺失或采集失败时，才使用该平台的成熟榜单作为回退输入，避免成熟作品数量淹没当前开书信号。
