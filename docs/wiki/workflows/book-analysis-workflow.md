...
- 成功拆书必须提供“照着这本书写”的统一创作入口，不能要求新手在拆书、知识库、写法资产和开书页之间手动拼装。入口分成两种明确意图：`续写原作` 自动携带来源文档、拆书分析与写法资产，保留角色、世界、时间线和未完线索；`参考创作新书` 自动携带拆书分析与写法资产，但只把结构、节奏和技法作为一级参考，不把原作专名、角色、世界事实或具体剧情注入新书正文。
