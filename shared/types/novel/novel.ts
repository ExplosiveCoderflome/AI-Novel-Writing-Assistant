import type { BookAnalysisSectionKey } from "../common/bookAnalysis";
...
export type {
  ...
  StoryModeProfile,
} from "../common/storyMode";
export type {
  ChapterSceneCard,
  ChapterScenePlan,
  LengthBudgetContract,
} from "../chapter/chapterLengthControl";
...
export interface ChapterEditorAiRevisionRequest {
  ...
  provider?: import("../common/llm").LLMProvider;
  model?: string;
  temperature?: number;
}
