...
漫画工坊将小说文本延展为视觉创作。支持从已有小说中一键提取世界观与角色设定，并在生成分镜时保持背景一致性。分镜与角色面板支持图像生成确认，减少误触，帮助创作者完成小说改编漫画的视觉探索与一致性资产积累。

![漫画工坊](./images/漫画工坊.png)

### 视频/短剧改编

短剧与视频改编生产线（VellumReel）深度集成，支持通过小说分镜剧本一键合成 9:16 竖版视频。提供完全离线的中文/英文高保真 TTS 语音合成，自动过滤舞台调度与角色名噪音，并在 Stable Diffusion 离线时提供高清晰手绘国风水墨插画进行兜底，保障本地离线模式下的视频渲染质量与自然流畅度。
