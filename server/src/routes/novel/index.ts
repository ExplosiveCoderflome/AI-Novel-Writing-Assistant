...
import { registerNovelBaseRoutes } from "./baseRoutes";
import { registerNovelChapterEditorRoutes } from "./chapterEditorRoutes";
import { registerNovelChapterRoutes } from "./chapterRoutes";
import { registerNovelChapterGenerationRoutes } from "./chapterGeneration";
import { registerNovelCharacterDynamicsRoutes } from "./characterDynamicsRoutes";
import { registerNovelCharacterPreparationRoutes } from "./characterPreparationRoutes";
import { registerNovelCharacterResourceRoutes } from "./characterResourceRoutes";
import { registerNovelCharacterSyncRoutes } from "./characterSyncRoutes";
import { registerNovelFramingRoutes } from "./framingRoutes";
import { registerNovelPlanningRoutes } from "./planningRoutes";
import { registerNovelProductionRoutes } from "./productionRoutes";
import { registerNovelReviewRoutes } from "./reviewRoutes";
import { registerNovelSnapshotCharacterRoutes } from "./snapshotCharacterRoutes";
import { registerNovelStoryMacroRoutes } from "./storyMacroRoutes";
import { registerNovelStorylineRoutes } from "./storylineRoutes";
import { registerNovelVolumeRoutes } from "./volumeRoutes";
import { registerNovelWorldSliceRoutes } from "./worldSliceRoutes";
