...
function buildPromptMeta(promptMeta?: PromptInvocationMeta): Record<string, unknown> | null {
  ...
  return {
    ...
    effectiveTaskType: promptMeta.effectiveTaskType ?? null,
    estimatedInputTokens: promptMeta.estimatedInputTokens,
    renderedPromptChars: promptMeta.renderedPromptChars ?? null,
    renderedPromptTokensApprox: promptMeta.renderedPromptTokensApprox ?? null,
